    ...
    <div class="modal-dialog ">
        <div class="modal-content ">
            <div class="modal-header ">
                <h5 class="modal-title text-primary" id="loginModalLabel">Login to iDiscuss</h5>
            ...
            <form action="/forum/partials/_handleLogin.php" method="post">
                ...
                <div class="container my-3 col-md-5 ">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="user_email" class="form-control" id="loginEmail" name="loginEmail"
                    ...
                    <button type="submit" class="btn btn-primary my-3 col-md-5 ">Submit</button>
                </div>
